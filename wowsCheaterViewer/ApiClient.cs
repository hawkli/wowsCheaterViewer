...
namespace wowsCheaterViewer
{
    ...
    {
        static readonly string address_official = "https://vortex.wowsgame.cn";
        static readonly string address_yuyukoWowsApi_域名1 = "https://api.wows.shinoaki.com";//即将弃用
        static readonly string address_yuyukoWowsApi_域名2 = "https://api.wows.yuyuko.dev";//即将弃用
        static readonly string address_yuyukoWowsApi_域名3 = "https://v3-api.wows.shinoaki.com";
        static readonly string address_yuyuko战舰世界API平台接口处理与反向代理 = "https://dev-proxy.wows.shinoaki.com:7700";
        ...
        public static async Task<string?> PostClientAsync(string url, string? bodyString, Dictionary<string, string>? filePaths)//调用post接口，需要url，jsonBody和file选填
        {
            ...
            try
            {
                ...
                {
                    //处理bodyJson
                    StringContent content = new(bodyString, Encoding.UTF8, "application/json");
